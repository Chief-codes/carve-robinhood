...
import {loadArtifacts,viem,json,PROJECT_ROOT} from './prepare-deployment.mjs';
import {assertPlanMatchesArtifacts} from './verify-deployment.mjs';
const require=createRequire(import.meta.url);
const solc=require('solc');
const {encodeAbiParameters,keccak256,toHex}=viem;
const API='https://robinhoodchain.blockscout.com/api/';
const names={registry:'CarveContentRegistry',coordinator:'CarveDeployment',factory:'CarveFactoryV2',router:'CarveV4Router',engine:'CarveV4Engine'};
