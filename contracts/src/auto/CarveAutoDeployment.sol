...
import {CarveAutoFactory} from "./CarveAutoFactory.sol";
import {CarveAutoEngine} from "./CarveAutoEngine.sol";
import {CarveAutoRouter} from "./CarveAutoRouter.sol";
...
contract CarveAutoDeployment {
    ...
    CarveAutoFactory public immutable factory;
    CarveAutoRouter public immutable router;
    ...
    constructor(CarveContentRegistry registry_, address platformRecipient, bytes32 hookSalt) {
        ...
        registry = registry_;
        engine = new CarveAutoEngine{salt: hookSalt}(POOL_MANAGER, futureFactory);
        factory = new CarveAutoFactory(registry_, platformRecipient, address(engine));
