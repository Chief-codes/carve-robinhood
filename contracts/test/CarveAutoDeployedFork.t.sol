...
contract CarveAutoDeployedForkTest {
    ...
    function setUp() public {
        require(NFPM.code.length > 0 && block.chainid == 4663, "Robinhood mainnet fork required");
        vm.deal(address(this), 100 ether);
        registry = CarveContentRegistry(0xf28e75beFA6aEeC5beDF6AD5278b12e82580985F);
        factory = CarveAutoFactory(0xAFbF0a6a548BAD4320FC0fBe777055572B2F340a);
        engine = CarveAutoEngine(payable(0x832Fb03279d7b10B0f2F711Fc4251eBeC3ce2044));
        router = CarveAutoRouter(payable(0x097C5497a07fB9D50d818f5356eD847FD5dE23Bf));
        require(factory.version() == 5, "actual deployed release");
    }
